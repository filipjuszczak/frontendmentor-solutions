...
export default function ProductDetails({
  ...
  return (
    <div className="p-6 lg:p-0">
      <span className="mb-4 block text-[clamp(0.75rem,0.728rem+0.0939vi,0.8125rem)] font-bold uppercase tracking-[0.15em] text-[hsl(219,9,45)]">
        {manufacturer}
      </span>
      <h1 className="mb-[0.9375rem] text-[clamp(1.75rem,1.3979rem+1.5023vi,2.75rem)] font-bold leading-none text-veryDarkBlue lg:mb-8">
        {name}
      </h1>
      ...
      <div className="mb-6 flex items-center justify-between lg:mb-8 lg:flex-col lg:items-start lg:gap-[0.625rem]">
        <div className="flex items-center gap-4">
          <strong className="text-[1.75rem] font-bold text-veryDarkBlue">
            {currency}
            {discountedPrice.toFixed(2)}
          </strong>
          <span className="rounded-md bg-veryDarkBlue px-[0.625rem] py-1 font-bold text-white">
            {discount * 100}%
          </span>
        </div>
      ...
      <div className="flex flex-col lg:flex-row lg:gap-4">
        <div className="mb-4 flex items-center justify-between rounded-md bg-lightGrayishBlue lg:mb-0">
          ...
          <span className="font-bold text-veryDarkBlue lg:px-8">
            {quantity}
          </span>
          <button
